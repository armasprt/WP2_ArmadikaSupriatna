...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://localhost/WP2_ArmadikaSupriatna/pustaka-booking/assets/css/style.css">
</head>
<body>
    <div id="wrapper">
        <header>
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="<?php echo base_url().'index.php/web/service' ?>">Service</a></li>
